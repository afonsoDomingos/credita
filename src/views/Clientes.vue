      ...
      <table v-else-if="clientes.length > 0" class="data-table">
        ...
        <tbody>
          <tr v-for="cliente in clientes" :key="cliente._id">
            ...
            <td>
              <button class="btn-icon text-indigo" @click="$router.push(`/app/clientes/${cliente._id}`)" title="Ver Perfil">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z"/><circle cx="12" cy="12" r="3"/></svg>
              </button>
              <button class="btn-icon text-blue ml-2" @click="openModal(cliente)" title="Editar">
                <Edit2 :size="18" />
              </button>
